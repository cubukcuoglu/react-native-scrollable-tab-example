...
import { IStoryItem } from "@services";

import styles from "./style";
import Item from "./Item";

const Stories: FC = () => {
    const { isRefreshing, isLoaded, data, notice, noticeCanVisible, refresh, next } = useList<IStoryItem>("stories");
    ...
    return (
        <ScrollableTab.FlatList
            ...
            ListFooterComponent={hasNextPage ? <Loading style={styles.loadingBottom} isVisible relative /> : null}
